...
let private excludeWords = [ "don"; "won"; "doesn" ]

let private excludeNames = [ "Holsten"; "Lain"; "Portia"; "Guyen"; "Bianca"; "Karst"; "Vitas"; "Scoles"; "Avrana"
                             "Viola"; "Alpash"; "Nessel"; "Eliza"; "Sering"; "Brin" ]
